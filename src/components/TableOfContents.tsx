...
export default function TableOfContents({ headings }: TableOfContentsProps) {
  ...
  return (
    <nav className="pr-8 pb-12">
      <a
        href="/projects"
        className="group mb-12 inline-flex items-center gap-2 text-[10px] font-bold tracking-[0.15em] text-[var(--color-on-surface-muted)] uppercase transition-colors hover:text-[var(--color-on-surface)]"
      >
        ...
        {tocHeadings.map((heading) => {
          ...
          return (
            ...
            >
              ...
              {isActive && (
                <div className="absolute top-1/2 -left-[5px] z-10 h-2 w-2 -translate-y-1/2 rounded-full bg-[#f26522]" />
              )}
